...
public class SortTest {
     ...
     * max size is 1000 and max element is 10000 "adjustable"
     */
   public ArrayList<Integer> randomList() {
    ...
    public void intermediateCountSort() throws IOException {
        ArrayReader cases = new ArrayReader("C:\\Users\\Amir\\OneDrive - Alexandria University\\Desktop\\FOE-AU\\CSED_Y2_2nd Semester\\Data Structures & Algorithms\\Labs\\Final\\Main\\src\\Count Sort Intermediate Test.txt");
        ArrayList<ArrayList<Integer>> temp = cases.read();
        ArrayList<Integer> list = temp.get(0);
        temp.remove(0);
        ArrayList<ArrayList<Integer>> expected = new ArrayList<>();
